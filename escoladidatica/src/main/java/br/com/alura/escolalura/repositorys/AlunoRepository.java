...
public class AlunoRepository {
	...
	private void criarConexao() {
		...
		this.bancaDeDados = cliente.getDatabase("alunosTestes");
	...
	public void salvar(Aluno aluno){
		...
		criarConexao();
		MongoCollection<Aluno> alunos = this.bancaDeDados.getCollection("alunosTestes", Aluno.class);
		if (aluno.getId() == null) {
	...
	public List<Aluno> pesquisarPor(String nome) {
		criarConexao();
		MongoCollection<Aluno> alunoCollection = this.bancaDeDados.getCollection("alunosTestes" , Aluno.class);
